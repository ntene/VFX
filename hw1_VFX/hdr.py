...
img = [cv2.resize(i, (10,10)) for i in images]

img = np.array(img).transpose(3,0,1,2)
Z = img.reshape((3,num_images,100)).transpose(0,2,1)
print ("**")
print (Z.shape)
z_min = 0
z_max = 255
...
im_color = cv2.applyColorMap(E_8bit, cv2.COLORMAP_COOL)
cv2.imwrite('a.jpg', im_color)
